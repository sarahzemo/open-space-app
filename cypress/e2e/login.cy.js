describe('Login spec', () => {
  ...
  it('should display login page correcly', () => {
    //Memverikasi elemen yang harus tampaK pada halaman login
  ...
  it('should display alert when username is empty', () => {
    ...
    //memverfikasi window.alert untuk menampilkan pesan dari API
