 ...
 *  = should return the talks with the new talk when iben by ADD_TALK action
...
describe('talkReducers function', () => {
  ...
  it('should return the talk with the toggle like talk when given by TOGGLE_LIKE_TALK action', () => {
    // arrange
    const initialState = [
      {
        id: 'talk-1',
